// Day11MonkeyintheMiddle1.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	for (size_t r = 0; r < rounds; r++) {
		...
		std::cout << "After round " << (r+1) << ", the monkeys are holding items with these worry levels:\n";
		for (auto m : monkeys) {
			std::cout << "Monkey " << m.number << ": ";
